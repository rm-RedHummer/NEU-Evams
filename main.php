...
<style>
    ...
    .submit-btn{
      background-image: linear-gradient(to bottom right, #0099FF, #330066);
      border:none;
    }
    body {
        overflow-x: hidden;
...
<body>
    <div class="row main-title pt-5">
        <div class="col-md-2"></div>
        <div class="col-md-8">
            <img src="images/New_Era_University.png" width="125px" height="125" style="float: left;">
            <h2 class="title-header text-center font-weight-light">NEU FAIR 2019 REGISTRATION</h2>
        </div>
        <div class="col-md-2">
            <div class="btn-group dropleft mt-4 pt-3">
        ...
        <div class="col-md-5">
            <form method="post" enctype="multipart/form-data">
                <div class="form-group row">
                    <label for="initials" class="col-sm-3 col-form-label">Name</label>
                    <div class="col-sm-9">
                        <input type="text" name="initials" class="form-control form-rounded" id="initials" placeholder="Name" autocomplete="off" required>
                    </div>
                </div>

                <div class="form-group row">
                    <label for="json-one" class="col-sm-3 col-form-label">College</label>
                    <div class="col-sm-9">
                        <select name="college" id="json-one" class="form-control form-rounded" required>
                ...
                <div class="form-group row">
                    <label for="json-two" class="col-sm-3 col-form-label">Course</label>
                    <div class="col-sm-9">
                        <select name="course" id="json-two" class="form-control form-rounded" required>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <select name="yearLevel" id="yearLevel" class="form-control form-rounded" required>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="email" class="form-control form-rounded" id="email" placeholder="Email" autocomplete="off" required>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input type="submit" class="btn btn-primary form-rounded submit-btn" value="Generate Registration" name="register">
                    </div>
                </div>
