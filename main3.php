                ...
                <div class="col-md-5">
                    ...
                    <?php
                        if(isset($_POST['register'])) {
                            ...
                            $mail->Port = 587;
                            $mail->Username = 'neufair';
                            $mail->Password = 'alabNEU2019';
                            $mail->isHTML(true);
                            ...
                            $mail->setFrom('neufair@gmail.com','Neu Fair');
                            $mail->addAddress('neufair@gmail.com');
...
<script>
    $(function() {
        ...
        $("#json-one").change(function() {
            ...
            $.getJSON("jsondata/jsoncourses.json", function(data) {
